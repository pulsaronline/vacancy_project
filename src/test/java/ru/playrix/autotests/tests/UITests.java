...
public class UITests extends TestBase {
    ...
    void mainPageUITest() {
        Allure.step("Init web driver", DriverHelper::configureDriver);
        Allure.step("Open main page", MainPage::openMainPage);
        Allure.step("Accept cookies", UIHelper::acceptCookies);
    ...
    void vacancyPageUITest() {
        ...
        Allure.step("Open vacancy page", VacancyPage::openVacancyPage);
    ...
    void cvPageFillAndCheckUITest() {
        step("Init web driver", DriverHelper::configureDriver);
        Allure.step("Open target page", CvPage::openCvPage);
        step("Accept cookies", UIHelper::acceptCookies);
